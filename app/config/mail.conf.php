...
$platform_email['SMTP_FROM_EMAIL'] = (isset($administrator['email']) ? $administrator['email'] : 'gurupandamy@gmail.com');
$platform_email['SMTP_FROM_NAME'] = (isset($administrator['name']) ? $administrator['name'] : 'Admin');
$platform_email['SMTP_HOST'] = 'smtp.gmail.com';
...
$platform_email['SMTP_USER'] = 'gurupandamy@gmail.com';
$platform_email['SMTP_PASS'] = 'admin.12345';
